...
const MemoModal = ({ onClose }: MemoModalProps) => {
    ...
    return (
      <div className="fixed inset-0 z-[130] flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none">
        <div className="fixed inset-0 transition-opacity">
          <div className="absolute inset-0 bg-black opacity-50" onClick={onClose}></div>
        </div>
        <div className="relative z-[140] bg-white rounded-lg h-[284px] w-[300px] p-4">
